<script lang="ts">
  ...
  function advanceAnimation() {
    ...
    if (animate) requestAnimationFrame(advanceAnimation)
  }
...
<div class="relative flex w-svw flex-col gap-y-3 p-4">
  ...
  {/if}
  <div
    class="pointer-events-none absolute z-10 text-nowrap rounded-md bg-slate-50 px-2 py-1 dark:bg-slate-700 {mouseDown &&
    mouseOver &&
    mouseY >= 0 &&
